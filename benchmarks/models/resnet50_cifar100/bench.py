"""ResNet-50 with the CIFAR stem, 23 705 252 parameters, on 32x32 CIFAR-100, 100 classes.
The architecture is ``benchmarks/models/resnet50_cifar``'s with a 100-way head; same images,
...
Hyperparameters are the CIFAR-10 counterpart's, not re-tuned for 100 classes; batch 128.
    ...
    python -m benchmarks.models.resnet50_cifar100.bench --epochs 50 --budget-mode wct \\
