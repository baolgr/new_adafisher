#!/bin/bash
# CIFAR-10, ViT-S/4, arm=adamw. Writes to benchmarks/outputs/vit_small_cifar/adamw/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/train_vit_small_cifar_adamw.sh
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/train_vit_small_cifar_adamw.sh
...
python -m benchmarks.vit_small_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/vit_small_cifar/adamw"
