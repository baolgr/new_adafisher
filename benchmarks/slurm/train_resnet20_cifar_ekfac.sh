#!/bin/bash
# CIFAR-10, ResNet-20, arm=ekfac. Writes to benchmarks/outputs/resnet20_cifar/ekfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/train_resnet20_cifar_ekfac.sh
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/train_resnet20_cifar_ekfac.sh
...
python -m benchmarks.resnet20_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/resnet20_cifar/ekfac"
