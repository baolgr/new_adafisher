...
# Submit from the repository root:  sbatch benchmarks/slurm/calibrate_resnet50_cifar.sh
...
python -m benchmarks.resnet50_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/resnet50_cifar/_calibration"
