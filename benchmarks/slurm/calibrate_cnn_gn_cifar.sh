...
# Submit from the repository root:  sbatch benchmarks/slurm/calibrate_cnn_gn_cifar.sh
...
python -m benchmarks.cnn_gn_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cnn_gn_cifar/_calibration"
