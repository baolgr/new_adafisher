#!/bin/bash
# CIFAR-10, ViT-S/4, all 7 arms in one job. Writes to benchmarks/outputs/vit_small_cifar/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/train_vit_small_cifar_all.sh
...
#
# The per-arm alternative is benchmarks/slurm/train_vit_small_cifar_<arm>.sh, one job each; use it if you
...
python -m benchmarks.vit_small_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/vit_small_cifar"
