#!/bin/bash
# ImageNet-1K, ResNet-50, arm=tekfac. Writes to benchmarks/outputs/imagenet/resnet50_imagenet/tekfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/imagenet/train_resnet50_imagenet_tekfac.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=resnet50_imagenet_tekfac
#SBATCH --gpus=h100:1
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/imagenet/train_resnet50_imagenet_tekfac.sh
...
python -m benchmarks.resnet50_imagenet.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/imagenet/resnet50_imagenet/tekfac"
