#!/bin/bash
# ImageNet-1K @32px, CCT-2/3x2, all 7 arms in one job. Writes to benchmarks/outputs/imagenet/cct_2_3x2_imagenet/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/imagenet/train_cct_2_3x2_imagenet_all.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cct_2_3x2_imagenet_all
...
#
# The per-arm alternative is benchmarks/slurm/imagenet/train_cct_2_3x2_imagenet_<arm>.sh, one job each; use it if you
...
python -m benchmarks.cct_2_3x2_imagenet.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/imagenet/cct_2_3x2_imagenet"
