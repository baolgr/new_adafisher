#!/bin/bash
# ImageNet-1K @32px, ViT-micro d=32, arm=tekfac. Writes to benchmarks/outputs/imagenet/vit_micro_imagenet/tekfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/imagenet/train_vit_micro_imagenet_tekfac.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=vit_micro_imagenet_tekfac
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/imagenet/train_vit_micro_imagenet_tekfac.sh
...
python -m benchmarks.models.vit_micro_imagenet.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/imagenet/vit_micro_imagenet/tekfac"
