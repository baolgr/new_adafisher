#!/bin/bash
# ImageNet-1K, ResNet-50: calibration pass, all arms, 2 epochs on a 5k subset.
...
# Submit from the repository root:  sbatch benchmarks/slurm/imagenet/calibrate_resnet50_imagenet.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cal_resnet50_imagenet
#SBATCH --gpus=h100:1
...
python -m benchmarks.resnet50_imagenet.bench \
  ...
  --no-allow-download \
  --data-root "$DATA_ROOT" \
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/imagenet/resnet50_imagenet/_calibration"
