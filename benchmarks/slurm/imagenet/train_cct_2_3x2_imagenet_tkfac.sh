#!/bin/bash
# ImageNet-1K @32px, CCT-2/3x2, arm=tkfac. Writes to benchmarks/outputs/imagenet/cct_2_3x2_imagenet/tkfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/imagenet/train_cct_2_3x2_imagenet_tkfac.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cct_2_3x2_imagenet_tkfac
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/imagenet/train_cct_2_3x2_imagenet_tkfac.sh
...
python -m benchmarks.models.cct_2_3x2_imagenet.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/imagenet/cct_2_3x2_imagenet/tkfac"
