#!/bin/bash
# ImageNet-1K, ResNet-50, arm=ekfac. Writes to benchmarks/outputs/imagenet/resnet50_imagenet/ekfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/imagenet/train_resnet50_imagenet_ekfac.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=resnet50_imagenet_ekfac
#SBATCH --gpus=h100:1
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/imagenet/train_resnet50_imagenet_ekfac.sh
...
python -m benchmarks.resnet50_imagenet.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/imagenet/resnet50_imagenet/ekfac"
