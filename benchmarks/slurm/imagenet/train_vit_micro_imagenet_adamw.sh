#!/bin/bash
# ImageNet-1K @32px, ViT-micro d=32, arm=adamw. Writes to benchmarks/outputs/imagenet/vit_micro_imagenet/adamw/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/imagenet/train_vit_micro_imagenet_adamw.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=vit_micro_imagenet_adamw
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/imagenet/train_vit_micro_imagenet_adamw.sh
...
python -m benchmarks.models.vit_micro_imagenet.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/imagenet/vit_micro_imagenet/adamw"
