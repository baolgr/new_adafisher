#!/bin/bash
# ImageNet-1K @32px, ResNet-20, arm=adam. Writes to benchmarks/outputs/imagenet/resnet20_imagenet/adam/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/imagenet/train_resnet20_imagenet_adam.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=resnet20_imagenet_adam
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/imagenet/train_resnet20_imagenet_adam.sh
...
python -m benchmarks.models.resnet20_imagenet.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/imagenet/resnet20_imagenet/adam"
