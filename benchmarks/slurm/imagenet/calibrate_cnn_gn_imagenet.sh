#!/bin/bash
# ImageNet-1K @32px, CNN 16-32-64 + GroupNorm: calibration pass, all arms, 2 epochs on a 5k subset.
...
# Submit from the repository root:  sbatch benchmarks/slurm/imagenet/calibrate_cnn_gn_imagenet.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cal_cnn_gn_imagenet
...
python -m benchmarks.cnn_gn_imagenet.bench \
  ...
  --no-allow-download \
  --data-root "$DATA_ROOT" \
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/imagenet/cnn_gn_imagenet/_calibration"
