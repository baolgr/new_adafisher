#!/bin/bash
# ImageNet-1K, ResNet-50, arm=kfac. Writes to benchmarks/outputs/imagenet/resnet50_imagenet/kfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/imagenet/train_resnet50_imagenet_kfac.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=resnet50_imagenet_kfac
#SBATCH --gpus=h100:1
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/imagenet/train_resnet50_imagenet_kfac.sh
...
python -m benchmarks.models.resnet50_imagenet.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/imagenet/resnet50_imagenet/kfac"
