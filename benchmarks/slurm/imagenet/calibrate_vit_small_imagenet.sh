#!/bin/bash
# ImageNet-1K, ViT-S/16: calibration pass, all arms, 2 epochs on a 5k subset.
...
# Submit from the repository root:  sbatch benchmarks/slurm/imagenet/calibrate_vit_small_imagenet.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cal_vit_small_imagenet
#SBATCH --gpus=h100:1
...
python -m benchmarks.vit_small_imagenet.bench \
  ...
  --no-allow-download \
  --data-root "$DATA_ROOT" \
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/imagenet/vit_small_imagenet/_calibration"
