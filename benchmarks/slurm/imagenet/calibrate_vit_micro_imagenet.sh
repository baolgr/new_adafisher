#!/bin/bash
# ImageNet-1K @32px, ViT-micro d=32: calibration pass, all arms, 2 epochs on a 5k subset.
...
# Submit from the repository root:  sbatch benchmarks/slurm/imagenet/calibrate_vit_micro_imagenet.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cal_vit_micro_imagenet
...
python -m benchmarks.models.vit_micro_imagenet.bench \
  ...
  --no-allow-download \
  --data-root "$DATA_ROOT" \
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/imagenet/vit_micro_imagenet/_calibration"
