#!/bin/bash
# ImageNet-1K, ViT-S/16, arm=adam. Writes to benchmarks/outputs/imagenet/vit_small_imagenet/adam/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/imagenet/train_vit_small_imagenet_adam.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=vit_small_imagenet_adam
#SBATCH --gpus=h100:1
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/imagenet/train_vit_small_imagenet_adam.sh
...
python -m benchmarks.vit_small_imagenet.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/imagenet/vit_small_imagenet/adam"
