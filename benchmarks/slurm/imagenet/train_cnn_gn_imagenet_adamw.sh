#!/bin/bash
# ImageNet-1K @32px, CNN 16-32-64 + GroupNorm, arm=adamw. Writes to benchmarks/outputs/imagenet/cnn_gn_imagenet/adamw/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/imagenet/train_cnn_gn_imagenet_adamw.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cnn_gn_imagenet_adamw
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/imagenet/train_cnn_gn_imagenet_adamw.sh
...
python -m benchmarks.models.cnn_gn_imagenet.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/imagenet/cnn_gn_imagenet/adamw"
