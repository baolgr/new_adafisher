#!/bin/bash
# ImageNet-1K @32px, CNN 16-32-64 + GroupNorm, arm=tkfac. Writes to benchmarks/outputs/imagenet/cnn_gn_imagenet/tkfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/imagenet/train_cnn_gn_imagenet_tkfac.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cnn_gn_imagenet_tkfac
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/imagenet/train_cnn_gn_imagenet_tkfac.sh
...
python -m benchmarks.cnn_gn_imagenet.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/imagenet/cnn_gn_imagenet/tkfac"
