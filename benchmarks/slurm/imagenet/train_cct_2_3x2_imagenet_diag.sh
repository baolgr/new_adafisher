#!/bin/bash
# ImageNet-1K @32px, CCT-2/3x2, arm=diag (WCT reference arm). Writes to benchmarks/outputs/imagenet/cct_2_3x2_imagenet/diag/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/imagenet/train_cct_2_3x2_imagenet_diag.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cct_2_3x2_imagenet_diag
...
python -m benchmarks.models.cct_2_3x2_imagenet.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/imagenet/cct_2_3x2_imagenet/diag"
