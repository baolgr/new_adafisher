#!/bin/bash
# ImageNet-1K @32px, CCT-2/3x2, arm=tekfac. Writes to benchmarks/outputs/imagenet/cct_2_3x2_imagenet/tekfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/imagenet/train_cct_2_3x2_imagenet_tekfac.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cct_2_3x2_imagenet_tekfac
...
# --time: ESTIMATED. 27.9x cct_2_3x2_cifar's samples/epoch, 40 epochs.
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/imagenet/train_cct_2_3x2_imagenet_tekfac.sh
...
python -m benchmarks.cct_2_3x2_imagenet.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/imagenet/cct_2_3x2_imagenet/tekfac"
