#!/bin/bash
# ImageNet-1K @32px, ResNet-20: calibration pass, all arms, 2 epochs on a 5k subset.
...
# Submit from the repository root:  sbatch benchmarks/slurm/imagenet/calibrate_resnet20_imagenet.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cal_resnet20_imagenet
...
python -m benchmarks.models.resnet20_imagenet.bench \
  ...
  --no-allow-download \
  --data-root "$DATA_ROOT" \
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/imagenet/resnet20_imagenet/_calibration"
