#!/bin/bash
# ImageNet-1K, ViT-S/16, arm=tekfac. Writes to benchmarks/outputs/imagenet/vit_small_imagenet/tekfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/imagenet/train_vit_small_imagenet_tekfac.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=vit_small_imagenet_tekfac
#SBATCH --gpus=h100:1
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/imagenet/train_vit_small_imagenet_tekfac.sh
...
python -m benchmarks.vit_small_imagenet.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/imagenet/vit_small_imagenet/tekfac"
