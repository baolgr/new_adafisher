#!/bin/bash
# ImageNet-1K, ViT-S/16, arm=ekfac. Writes to benchmarks/outputs/imagenet/vit_small_imagenet/ekfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/imagenet/train_vit_small_imagenet_ekfac.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=vit_small_imagenet_ekfac
#SBATCH --gpus=h100:1
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/imagenet/train_vit_small_imagenet_ekfac.sh
...
python -m benchmarks.vit_small_imagenet.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/imagenet/vit_small_imagenet/ekfac"
