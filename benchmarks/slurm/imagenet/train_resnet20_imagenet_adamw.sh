#!/bin/bash
# ImageNet-1K @32px, ResNet-20, arm=adamw. Writes to benchmarks/outputs/imagenet/resnet20_imagenet/adamw/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/imagenet/train_resnet20_imagenet_adamw.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=resnet20_imagenet_adamw
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/imagenet/train_resnet20_imagenet_adamw.sh
...
python -m benchmarks.models.resnet20_imagenet.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/imagenet/resnet20_imagenet/adamw"
