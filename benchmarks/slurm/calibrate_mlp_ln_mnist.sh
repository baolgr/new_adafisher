...
# Submit from the repository root:  sbatch benchmarks/slurm/calibrate_mlp_ln_mnist.sh
...
python -m benchmarks.mlp_ln_mnist.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/mlp_ln_mnist/_calibration"
