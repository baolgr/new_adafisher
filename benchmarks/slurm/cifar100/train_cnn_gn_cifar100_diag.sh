#!/bin/bash
# CIFAR-100, CNN 16-32-64 + GroupNorm, arm=diag (WCT reference arm). Writes to benchmarks/outputs/cifar100/cnn_gn_cifar100/diag/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar100/train_cnn_gn_cifar100_diag.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cnn_gn_cifar100_diag
...
# --time: DERIVED from cnn_gn_cifar (MEASURED, 46.0 s).
...
#   python -c "import json;print(json.load(open('benchmarks/outputs/cifar100/cnn_gn_cifar100/diag/manifest.json'))['arms']['diag']['total_s'])"
...
python -m benchmarks.models.cnn_gn_cifar100.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar100/cnn_gn_cifar100/diag"
