#!/bin/bash
# CIFAR-100, CCT-2/3x2, arm=adamw. Writes to benchmarks/outputs/cifar100/cct_2_3x2_cifar100/adamw/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar100/train_cct_2_3x2_cifar100_adamw.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cct_2_3x2_cifar100_adamw
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/cifar100/train_cct_2_3x2_cifar100_adamw.sh
...
python -m benchmarks.models.cct_2_3x2_cifar100.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar100/cct_2_3x2_cifar100/adamw"
