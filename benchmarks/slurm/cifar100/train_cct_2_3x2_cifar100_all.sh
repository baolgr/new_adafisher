#!/bin/bash
# CIFAR-100, CCT-2/3x2, all 7 arms in one job. Writes to benchmarks/outputs/cifar100/cct_2_3x2_cifar100/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar100/train_cct_2_3x2_cifar100_all.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cct_2_3x2_cifar100_all
...
# --time: DERIVED from cct_2_3x2_cifar (MEASURED).
...
#
# The per-arm alternative is benchmarks/slurm/cifar100/train_cct_2_3x2_cifar100_<arm>.sh, one job each; use it if you
...
python -m benchmarks.models.cct_2_3x2_cifar100.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar100/cct_2_3x2_cifar100"
