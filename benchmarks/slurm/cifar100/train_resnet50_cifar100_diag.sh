#!/bin/bash
# CIFAR-100, ResNet-50, arm=diag (WCT reference arm). Writes to benchmarks/outputs/cifar100/resnet50_cifar100/diag/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar100/train_resnet50_cifar100_diag.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=resnet50_cifar100_diag
...
# --time: DERIVED from resnet50_cifar (MEASURED, 2822.8 s). PER-ARM figure.
...
#   python -c "import json;print(json.load(open('benchmarks/outputs/cifar100/resnet50_cifar100/diag/manifest.json'))['arms']['diag']['total_s'])"
...
python -m benchmarks.models.resnet50_cifar100.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar100/resnet50_cifar100/diag"
