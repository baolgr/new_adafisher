#!/bin/bash
# CIFAR-100, ViT-S/4, arm=adam. Writes to benchmarks/outputs/cifar100/vit_small_cifar100/adam/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar100/train_vit_small_cifar100_adam.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=vit_small_cifar100_adam
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/cifar100/train_vit_small_cifar100_adam.sh
...
python -m benchmarks.models.vit_small_cifar100.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar100/vit_small_cifar100/adam"
