#!/bin/bash
# CIFAR-100, CNN 16-32-64 + GroupNorm, all 7 arms in one job. Writes to benchmarks/outputs/cifar100/cnn_gn_cifar100/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar100/train_cnn_gn_cifar100_all.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cnn_gn_cifar100_all
...
# --time: DERIVED from cnn_gn_cifar (MEASURED).
...
#
# The per-arm alternative is benchmarks/slurm/cifar100/train_cnn_gn_cifar100_<arm>.sh, one job each; use it if you
...
python -m benchmarks.models.cnn_gn_cifar100.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar100/cnn_gn_cifar100"
