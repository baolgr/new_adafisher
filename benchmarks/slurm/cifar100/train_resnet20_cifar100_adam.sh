#!/bin/bash
# CIFAR-100, ResNet-20, arm=adam. Writes to benchmarks/outputs/cifar100/resnet20_cifar100/adam/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar100/train_resnet20_cifar100_adam.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=resnet20_cifar100_adam
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/cifar100/train_resnet20_cifar100_adam.sh
...
python -m benchmarks.models.resnet20_cifar100.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar100/resnet20_cifar100/adam"
