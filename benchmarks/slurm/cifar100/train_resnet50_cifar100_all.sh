#!/bin/bash
# CIFAR-100, ResNet-50, all 7 arms in one job. Writes to benchmarks/outputs/cifar100/resnet50_cifar100/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar100/train_resnet50_cifar100_all.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=resnet50_cifar100_all
...
# --time: DERIVED from resnet50_cifar (MEASURED).
...
#
# The per-arm alternative is benchmarks/slurm/cifar100/train_resnet50_cifar100_<arm>.sh, one job each; use it if you
...
python -m benchmarks.models.resnet50_cifar100.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar100/resnet50_cifar100"
