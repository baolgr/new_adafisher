#!/bin/bash
# CIFAR-100, ViT-micro d=32, arm=tekfac. Writes to benchmarks/outputs/cifar100/vit_micro_cifar100/tekfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar100/train_vit_micro_cifar100_tekfac.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=vit_micro_cifar100_tekfac
...
# --time: DERIVED from vit_micro_cifar (MEASURED, 67.4 s).
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/cifar100/train_vit_micro_cifar100_tekfac.sh
...
python -m benchmarks.vit_micro_cifar100.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar100/vit_micro_cifar100/tekfac"
