#!/bin/bash
# CIFAR-100, CNN 16-32-64 + GroupNorm, arm=tekfac. Writes to benchmarks/outputs/cifar100/cnn_gn_cifar100/tekfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar100/train_cnn_gn_cifar100_tekfac.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cnn_gn_cifar100_tekfac
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/cifar100/train_cnn_gn_cifar100_tekfac.sh
...
python -m benchmarks.models.cnn_gn_cifar100.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar100/cnn_gn_cifar100/tekfac"
