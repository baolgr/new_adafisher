#!/bin/bash
# CIFAR-100, CCT-2/3x2: calibration pass, all arms, 2 epochs on a 5k subset.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar100/calibrate_cct_2_3x2_cifar100.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cal_cct_2_3x2_cifar100
...
python -m benchmarks.models.cct_2_3x2_cifar100.bench \
  ...
  --no-allow-download \
  --data-root "$DATA_ROOT" \
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar100/cct_2_3x2_cifar100/_calibration"
