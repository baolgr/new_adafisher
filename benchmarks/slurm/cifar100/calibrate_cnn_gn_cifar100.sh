#!/bin/bash
# CIFAR-100, CNN 16-32-64 + GroupNorm: calibration pass, all arms, 2 epochs on a 5k subset.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar100/calibrate_cnn_gn_cifar100.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cal_cnn_gn_cifar100
...
python -m benchmarks.models.cnn_gn_cifar100.bench \
  ...
  --no-allow-download \
  --data-root "$DATA_ROOT" \
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar100/cnn_gn_cifar100/_calibration"
