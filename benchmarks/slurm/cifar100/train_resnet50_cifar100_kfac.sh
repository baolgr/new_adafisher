#!/bin/bash
# CIFAR-100, ResNet-50, arm=kfac. Writes to benchmarks/outputs/cifar100/resnet50_cifar100/kfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar100/train_resnet50_cifar100_kfac.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=resnet50_cifar100_kfac
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/cifar100/train_resnet50_cifar100_kfac.sh
...
python -m benchmarks.resnet50_cifar100.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar100/resnet50_cifar100/kfac"
