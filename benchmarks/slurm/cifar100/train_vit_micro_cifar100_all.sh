#!/bin/bash
# CIFAR-100, ViT-micro d=32, all 7 arms in one job. Writes to benchmarks/outputs/cifar100/vit_micro_cifar100/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar100/train_vit_micro_cifar100_all.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=vit_micro_cifar100_all
...
# --time: DERIVED from vit_micro_cifar (MEASURED).
...
#
# The per-arm alternative is benchmarks/slurm/cifar100/train_vit_micro_cifar100_<arm>.sh, one job each; use it if you
...
python -m benchmarks.models.vit_micro_cifar100.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar100/vit_micro_cifar100"
