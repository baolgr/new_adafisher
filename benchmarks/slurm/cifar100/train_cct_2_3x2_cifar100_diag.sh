#!/bin/bash
# CIFAR-100, CCT-2/3x2, arm=diag (WCT reference arm). Writes to benchmarks/outputs/cifar100/cct_2_3x2_cifar100/diag/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar100/train_cct_2_3x2_cifar100_diag.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cct_2_3x2_cifar100_diag
...
# --time: DERIVED from cct_2_3x2_cifar (MEASURED, 237.5 s).
...
#   python -c "import json;print(json.load(open('benchmarks/outputs/cifar100/cct_2_3x2_cifar100/diag/manifest.json'))['arms']['diag']['total_s'])"
...
python -m benchmarks.models.cct_2_3x2_cifar100.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar100/cct_2_3x2_cifar100/diag"
