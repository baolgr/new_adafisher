#!/bin/bash
# CIFAR-100, ViT-S/4, arm=diag (WCT reference arm). Writes to benchmarks/outputs/cifar100/vit_small_cifar100/diag/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar100/train_vit_small_cifar100_diag.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=vit_small_cifar100_diag
...
# --time: DERIVED from vit_small_cifar (MEASURED, 987.8 s). PER-ARM figure.
...
#   python -c "import json;print(json.load(open('benchmarks/outputs/cifar100/vit_small_cifar100/diag/manifest.json'))['arms']['diag']['total_s'])"
...
python -m benchmarks.models.vit_small_cifar100.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar100/vit_small_cifar100/diag"
