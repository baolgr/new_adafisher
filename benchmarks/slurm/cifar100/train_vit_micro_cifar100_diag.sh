#!/bin/bash
# CIFAR-100, ViT-micro d=32, arm=diag (WCT reference arm). Writes to benchmarks/outputs/cifar100/vit_micro_cifar100/diag/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar100/train_vit_micro_cifar100_diag.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=vit_micro_cifar100_diag
...
python -m benchmarks.models.vit_micro_cifar100.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar100/vit_micro_cifar100/diag"
