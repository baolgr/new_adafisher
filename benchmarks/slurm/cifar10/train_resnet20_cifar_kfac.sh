#!/bin/bash
# CIFAR-10, ResNet-20, arm=kfac. Writes to benchmarks/outputs/cifar10/resnet20_cifar/kfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar10/train_resnet20_cifar_kfac.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=resnet20_cifar_kfac
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/cifar10/train_resnet20_cifar_kfac.sh
...
python -m benchmarks.models.resnet20_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar10/resnet20_cifar/kfac"
