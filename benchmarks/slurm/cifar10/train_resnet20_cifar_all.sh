#!/bin/bash
# CIFAR-10, ResNet-20, all 7 arms in one job. Writes to benchmarks/outputs/cifar10/resnet20_cifar/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar10/train_resnet20_cifar_all.sh
...
#
# The per-arm alternative is benchmarks/slurm/cifar10/train_resnet20_cifar_<arm>.sh, one job each; use it if you
...
python -m benchmarks.models.resnet20_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar10/resnet20_cifar"
