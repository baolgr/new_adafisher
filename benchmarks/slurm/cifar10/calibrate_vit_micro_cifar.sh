#!/bin/bash
# CIFAR-10, ViT-micro d=32: calibration pass, all arms, 2 epochs on a 5k subset.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar10/calibrate_vit_micro_cifar.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cal_vit_micro_cifar
...
python -m benchmarks.models.vit_micro_cifar.bench \
  ...
  --no-allow-download \
  --data-root "$DATA_ROOT" \
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar10/vit_micro_cifar/_calibration"
