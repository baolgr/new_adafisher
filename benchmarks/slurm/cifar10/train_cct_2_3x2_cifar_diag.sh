#!/bin/bash
# CIFAR-10, CCT-2/3x2, arm=diag (WCT reference arm). Writes to benchmarks/outputs/cifar10/cct_2_3x2_cifar/diag/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar10/train_cct_2_3x2_cifar_diag.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cct_2_3x2_cifar_diag
...
#   python -c "import json;print(json.load(open('benchmarks/outputs/cifar10/cct_2_3x2_cifar/diag/manifest.json'))['arms']['diag']['total_s'])"
...
python -m benchmarks.cct_2_3x2_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar10/cct_2_3x2_cifar/diag"
