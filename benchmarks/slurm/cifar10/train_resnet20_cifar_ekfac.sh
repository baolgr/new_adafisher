#!/bin/bash
# CIFAR-10, ResNet-20, arm=ekfac. Writes to benchmarks/outputs/cifar10/resnet20_cifar/ekfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar10/train_resnet20_cifar_ekfac.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=resnet20_cifar_ekfac
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/cifar10/train_resnet20_cifar_ekfac.sh
...
python -m benchmarks.models.resnet20_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar10/resnet20_cifar/ekfac"
