#!/bin/bash
# CIFAR-10, CCT-2/3x2, arm=adamw. Writes to benchmarks/outputs/cifar10/cct_2_3x2_cifar/adamw/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar10/train_cct_2_3x2_cifar_adamw.sh
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/cifar10/train_cct_2_3x2_cifar_adamw.sh
...
python -m benchmarks.models.cct_2_3x2_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar10/cct_2_3x2_cifar/adamw"
