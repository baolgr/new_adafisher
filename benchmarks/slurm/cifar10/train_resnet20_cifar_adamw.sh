#!/bin/bash
# CIFAR-10, ResNet-20, arm=adamw. Writes to benchmarks/outputs/cifar10/resnet20_cifar/adamw/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar10/train_resnet20_cifar_adamw.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=resnet20_cifar_adamw
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/cifar10/train_resnet20_cifar_adamw.sh
...
python -m benchmarks.models.resnet20_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar10/resnet20_cifar/adamw"
