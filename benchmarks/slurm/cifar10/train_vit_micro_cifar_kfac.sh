#!/bin/bash
# CIFAR-10, ViT-micro d=32, arm=kfac. Writes to benchmarks/outputs/cifar10/vit_micro_cifar/kfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar10/train_vit_micro_cifar_kfac.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=vit_micro_cifar_kfac
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/cifar10/train_vit_micro_cifar_kfac.sh
...
python -m benchmarks.models.vit_micro_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar10/vit_micro_cifar/kfac"
