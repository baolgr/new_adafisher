#!/bin/bash
# CIFAR-10, CCT-2/3x2, arm=kfac. Writes to benchmarks/outputs/cifar10/cct_2_3x2_cifar/kfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar10/train_cct_2_3x2_cifar_kfac.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cct_2_3x2_cifar_kfac
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/cifar10/train_cct_2_3x2_cifar_kfac.sh
...
python -m benchmarks.cct_2_3x2_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar10/cct_2_3x2_cifar/kfac"
