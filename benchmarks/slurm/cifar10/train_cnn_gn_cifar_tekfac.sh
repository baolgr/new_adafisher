#!/bin/bash
# CIFAR-10, CNN 16-32-64 + GroupNorm, arm=tekfac. Writes to benchmarks/outputs/cifar10/cnn_gn_cifar/tekfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar10/train_cnn_gn_cifar_tekfac.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cnn_gn_cifar_tekfac
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/cifar10/train_cnn_gn_cifar_tekfac.sh
...
python -m benchmarks.cnn_gn_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar10/cnn_gn_cifar/tekfac"
