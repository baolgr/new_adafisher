#!/bin/bash
# CIFAR-10, ResNet-50, arm=adam. Writes to benchmarks/outputs/cifar10/resnet50_cifar/adam/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar10/train_resnet50_cifar_adam.sh
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/cifar10/train_resnet50_cifar_adam.sh
...
python -m benchmarks.resnet50_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar10/resnet50_cifar/adam"
