#!/bin/bash
# CIFAR-10, CNN 16-32-64 + GroupNorm, all 7 arms in one job. Writes to benchmarks/outputs/cifar10/cnn_gn_cifar/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar10/train_cnn_gn_cifar_all.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cnn_gn_cifar_all
...
#
# The per-arm alternative is benchmarks/slurm/cifar10/train_cnn_gn_cifar_<arm>.sh, one job each; use it if you
...
python -m benchmarks.models.cnn_gn_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar10/cnn_gn_cifar"
