#!/bin/bash
# CIFAR-10, CCT-2/3x2: calibration pass, all arms, 2 epochs on a 5k subset.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar10/calibrate_cct_2_3x2_cifar.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cal_cct_2_3x2_cifar
...
python -m benchmarks.cct_2_3x2_cifar.bench \
  ...
  --no-allow-download \
  --data-root "$DATA_ROOT" \
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar10/cct_2_3x2_cifar/_calibration"
