#!/bin/bash
# CIFAR-10, ResNet-50, arm=ekfac. Writes to benchmarks/outputs/cifar10/resnet50_cifar/ekfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar10/train_resnet50_cifar_ekfac.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=resnet50_cifar_ekfac
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/cifar10/train_resnet50_cifar_ekfac.sh
...
python -m benchmarks.models.resnet50_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar10/resnet50_cifar/ekfac"
