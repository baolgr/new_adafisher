#!/bin/bash
# CIFAR-10, ResNet-20: calibration pass, all arms, 2 epochs on a 5k subset.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar10/calibrate_resnet20_cifar.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cal_resnet20_cifar
...
python -m benchmarks.models.resnet20_cifar.bench \
  ...
  --no-allow-download \
  --data-root "$DATA_ROOT" \
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar10/resnet20_cifar/_calibration"
