#!/bin/bash
# CIFAR-10, CNN 16-32-64 + GroupNorm, arm=adam. Writes to benchmarks/outputs/cifar10/cnn_gn_cifar/adam/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar10/train_cnn_gn_cifar_adam.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cnn_gn_cifar_adam
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/cifar10/train_cnn_gn_cifar_adam.sh
...
python -m benchmarks.models.cnn_gn_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar10/cnn_gn_cifar/adam"
