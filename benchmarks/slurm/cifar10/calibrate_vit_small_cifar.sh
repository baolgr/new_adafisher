#!/bin/bash
# CIFAR-10, ViT-S/4: calibration pass, all arms, 2 epochs on a 5k subset.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar10/calibrate_vit_small_cifar.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cal_vit_small_cifar
...
python -m benchmarks.models.vit_small_cifar.bench \
  ...
  --no-allow-download \
  --data-root "$DATA_ROOT" \
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar10/vit_small_cifar/_calibration"
