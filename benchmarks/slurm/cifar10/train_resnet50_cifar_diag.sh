#!/bin/bash
# CIFAR-10, ResNet-50, arm=diag (WCT reference arm). Writes to benchmarks/outputs/cifar10/resnet50_cifar/diag/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar10/train_resnet50_cifar_diag.sh
...
python -m benchmarks.models.resnet50_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar10/resnet50_cifar/diag"
