#!/bin/bash
# CIFAR-10, CNN 16-32-64 + GroupNorm: calibration pass, all arms, 2 epochs on a 5k subset.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar10/calibrate_cnn_gn_cifar.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cal_cnn_gn_cifar
...
python -m benchmarks.models.cnn_gn_cifar.bench \
  ...
  --no-allow-download \
  --data-root "$DATA_ROOT" \
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar10/cnn_gn_cifar/_calibration"
