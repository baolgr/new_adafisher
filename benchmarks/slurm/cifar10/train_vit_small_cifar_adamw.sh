#!/bin/bash
# CIFAR-10, ViT-S/4, arm=adamw. Writes to benchmarks/outputs/cifar10/vit_small_cifar/adamw/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/cifar10/train_vit_small_cifar_adamw.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=vit_small_cifar_adamw
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/cifar10/train_vit_small_cifar_adamw.sh
...
python -m benchmarks.models.vit_small_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cifar10/vit_small_cifar/adamw"
