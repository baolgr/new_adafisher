#!/bin/bash
# CIFAR-10, CCT-2/3x2, all 7 arms in one job. Writes to benchmarks/outputs/cct_2_3x2_cifar/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/train_cct_2_3x2_cifar_all.sh
...
#
# The per-arm alternative is benchmarks/slurm/train_cct_2_3x2_cifar_<arm>.sh, one job each; use it if you
...
python -m benchmarks.cct_2_3x2_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cct_2_3x2_cifar"
