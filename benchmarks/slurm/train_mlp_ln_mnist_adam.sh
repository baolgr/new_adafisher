#!/bin/bash
# MNIST, MLP 784-32-32-10 + LayerNorm, arm=adam. Writes to benchmarks/outputs/mlp_ln_mnist/adam/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/train_mlp_ln_mnist_adam.sh
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/train_mlp_ln_mnist_adam.sh
...
python -m benchmarks.mlp_ln_mnist.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/mlp_ln_mnist/adam"
