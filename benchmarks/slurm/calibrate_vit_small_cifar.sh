...
# Submit from the repository root:  sbatch benchmarks/slurm/calibrate_vit_small_cifar.sh
...
python -m benchmarks.vit_small_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/vit_small_cifar/_calibration"
