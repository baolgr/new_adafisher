#!/bin/bash
# CIFAR-10, CNN 16-32-64 + GroupNorm, arm=kfac. Writes to benchmarks/outputs/cnn_gn_cifar/kfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/train_cnn_gn_cifar_kfac.sh
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/train_cnn_gn_cifar_kfac.sh
...
python -m benchmarks.cnn_gn_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cnn_gn_cifar/kfac"
