...
# Submit from the repository root:  sbatch benchmarks/slurm/calibrate_resnet20_cifar.sh
...
python -m benchmarks.resnet20_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/resnet20_cifar/_calibration"
