#!/bin/bash
# MNIST, MLP 784-32-32-10 + LayerNorm, arm=ekfac. Writes to benchmarks/outputs/mlp_ln_mnist/ekfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/train_mlp_ln_mnist_ekfac.sh
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/train_mlp_ln_mnist_ekfac.sh
...
python -m benchmarks.mlp_ln_mnist.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/mlp_ln_mnist/ekfac"
