#!/bin/bash
# CIFAR-10, ResNet-50, all 7 arms in one job. Writes to benchmarks/outputs/resnet50_cifar/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/train_resnet50_cifar_all.sh
...
#
# The per-arm alternative is benchmarks/slurm/train_resnet50_cifar_<arm>.sh, one job each; use it if you
...
python -m benchmarks.resnet50_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/resnet50_cifar"
