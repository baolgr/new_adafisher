...
# Submit from the repository root:  sbatch benchmarks/slurm/calibrate_cct_2_3x2_cifar.sh
...
python -m benchmarks.cct_2_3x2_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cct_2_3x2_cifar/_calibration"
