...
# Submit from the repository root:  sbatch benchmarks/slurm/calibrate_vit_micro_cifar.sh
...
python -m benchmarks.vit_micro_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/vit_micro_cifar/_calibration"
