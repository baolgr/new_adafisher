#!/bin/bash
# MNIST auto-encoder 784-1000-500-250-30, arm=kfac. Writes to benchmarks/outputs/mnist_autoencoder/kfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/train_mnist_autoencoder_kfac.sh
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/train_mnist_autoencoder_kfac.sh
...
python -m benchmarks.mnist_autoencoder.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/mnist_autoencoder/kfac"
