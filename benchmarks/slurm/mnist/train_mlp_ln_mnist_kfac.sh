#!/bin/bash
# MNIST, MLP 784-32-32-10 + LayerNorm, arm=kfac. Writes to benchmarks/outputs/mnist/mlp_ln_mnist/kfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/mnist/train_mlp_ln_mnist_kfac.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=mlp_ln_mnist_kfac
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/mnist/train_mlp_ln_mnist_kfac.sh
...
python -m benchmarks.models.mlp_ln_mnist.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/mnist/mlp_ln_mnist/kfac"
