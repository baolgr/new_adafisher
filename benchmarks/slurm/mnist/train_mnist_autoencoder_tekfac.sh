#!/bin/bash
# MNIST auto-encoder 784-1000-500-250-30, arm=tekfac. Writes to benchmarks/outputs/mnist/mnist_autoencoder/tekfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/mnist/train_mnist_autoencoder_tekfac.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=mnist_autoencoder_tekfac
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/mnist/train_mnist_autoencoder_tekfac.sh
...
python -m benchmarks.models.mnist_autoencoder.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/mnist/mnist_autoencoder/tekfac"
