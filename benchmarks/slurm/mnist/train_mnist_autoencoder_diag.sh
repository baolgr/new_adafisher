#!/bin/bash
# MNIST auto-encoder 784-1000-500-250-30, arm=diag (WCT reference arm). Writes to benchmarks/outputs/mnist/mnist_autoencoder/diag/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/mnist/train_mnist_autoencoder_diag.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=mnist_autoencoder_diag
...
#   python -c "import json;print(json.load(open('benchmarks/outputs/mnist/mnist_autoencoder/diag/manifest.json'))['arms']['diag']['total_s'])"
...
python -m benchmarks.models.mnist_autoencoder.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/mnist/mnist_autoencoder/diag"
