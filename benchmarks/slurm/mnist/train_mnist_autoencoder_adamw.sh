#!/bin/bash
# MNIST auto-encoder 784-1000-500-250-30, arm=adamw. Writes to benchmarks/outputs/mnist/mnist_autoencoder/adamw/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/mnist/train_mnist_autoencoder_adamw.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=mnist_autoencoder_adamw
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/mnist/train_mnist_autoencoder_adamw.sh
...
python -m benchmarks.mnist_autoencoder.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/mnist/mnist_autoencoder/adamw"
