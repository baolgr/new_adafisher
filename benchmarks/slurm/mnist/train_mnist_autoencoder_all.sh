#!/bin/bash
# MNIST auto-encoder 784-1000-500-250-30, all 7 arms in one job. Writes to benchmarks/outputs/mnist/mnist_autoencoder/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/mnist/train_mnist_autoencoder_all.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=mnist_autoencoder_all
...
#
# The per-arm alternative is benchmarks/slurm/mnist/train_mnist_autoencoder_<arm>.sh, one job each; use it if you
...
python -m benchmarks.mnist_autoencoder.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/mnist/mnist_autoencoder"
