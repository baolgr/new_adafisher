#!/bin/bash
# MNIST auto-encoder 784-1000-500-250-30, arm=adam. Writes to benchmarks/outputs/mnist/mnist_autoencoder/adam/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/mnist/train_mnist_autoencoder_adam.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=mnist_autoencoder_adam
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/mnist/train_mnist_autoencoder_adam.sh
...
python -m benchmarks.mnist_autoencoder.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/mnist/mnist_autoencoder/adam"
