#!/bin/bash
# MNIST, MLP 784-32-32-10 + LayerNorm: calibration pass, all arms, 2 epochs on a 5k subset.
...
# Submit from the repository root:  sbatch benchmarks/slurm/mnist/calibrate_mlp_ln_mnist.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=cal_mlp_ln_mnist
...
python -m benchmarks.models.mlp_ln_mnist.bench \
  ...
  --no-allow-download \
  --data-root "$DATA_ROOT" \
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/mnist/mlp_ln_mnist/_calibration"
