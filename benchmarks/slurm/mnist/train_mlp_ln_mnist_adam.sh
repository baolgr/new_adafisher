#!/bin/bash
# MNIST, MLP 784-32-32-10 + LayerNorm, arm=adam. Writes to benchmarks/outputs/mnist/mlp_ln_mnist/adam/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/mnist/train_mlp_ln_mnist_adam.sh

#SBATCH --account=def-msh-ab
#SBATCH --job-name=mlp_ln_mnist_adam
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/mnist/train_mlp_ln_mnist_adam.sh
...
python -m benchmarks.mlp_ln_mnist.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/mnist/mlp_ln_mnist/adam"
