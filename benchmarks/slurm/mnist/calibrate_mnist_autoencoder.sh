...
# Submit from the repository root:  sbatch benchmarks/slurm/mnist/calibrate_mnist_autoencoder.sh
...
python -m benchmarks.mnist_autoencoder.bench \
  ...
  --no-allow-download \
  --data-root "$DATA_ROOT" \
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/mnist/mnist_autoencoder/_calibration"
