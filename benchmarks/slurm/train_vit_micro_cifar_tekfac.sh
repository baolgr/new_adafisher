#!/bin/bash
# CIFAR-10, ViT-micro d=32, arm=tekfac. Writes to benchmarks/outputs/vit_micro_cifar/tekfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/train_vit_micro_cifar_tekfac.sh
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/train_vit_micro_cifar_tekfac.sh
...
python -m benchmarks.vit_micro_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/vit_micro_cifar/tekfac"
