#!/bin/bash
# CIFAR-10, ResNet-20, arm=tekfac. Writes to benchmarks/outputs/resnet20_cifar/tekfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/train_resnet20_cifar_tekfac.sh
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/train_resnet20_cifar_tekfac.sh
...
python -m benchmarks.resnet20_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/resnet20_cifar/tekfac"
