#!/bin/bash
# CIFAR-10, ResNet-50, arm=adamw. Writes to benchmarks/outputs/resnet50_cifar/adamw/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/train_resnet50_cifar_adamw.sh
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/train_resnet50_cifar_adamw.sh
...
python -m benchmarks.resnet50_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/resnet50_cifar/adamw"
