#!/bin/bash
# CIFAR-10, CCT-2/3x2, arm=tkfac. Writes to benchmarks/outputs/cct_2_3x2_cifar/tkfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/train_cct_2_3x2_cifar_tkfac.sh
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/train_cct_2_3x2_cifar_tkfac.sh
...
python -m benchmarks.cct_2_3x2_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cct_2_3x2_cifar/tkfac"
