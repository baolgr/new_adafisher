#!/bin/bash
# CIFAR-10, ViT-S/4, arm=kfac. Writes to benchmarks/outputs/vit_small_cifar/kfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/train_vit_small_cifar_kfac.sh
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/train_vit_small_cifar_kfac.sh
...
python -m benchmarks.vit_small_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/vit_small_cifar/kfac"
