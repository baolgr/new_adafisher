#!/bin/bash
# CIFAR-10, CCT-2/3x2, arm=tekfac. Writes to benchmarks/outputs/cct_2_3x2_cifar/tekfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/train_cct_2_3x2_cifar_tekfac.sh
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/train_cct_2_3x2_cifar_tekfac.sh
...
python -m benchmarks.cct_2_3x2_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cct_2_3x2_cifar/tekfac"
