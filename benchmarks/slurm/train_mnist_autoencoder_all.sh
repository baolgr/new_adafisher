#!/bin/bash
# MNIST auto-encoder 784-1000-500-250-30, all 7 arms in one job. Writes to benchmarks/outputs/mnist_autoencoder/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/train_mnist_autoencoder_all.sh
...
python -m benchmarks.mnist_autoencoder.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/mnist_autoencoder"
