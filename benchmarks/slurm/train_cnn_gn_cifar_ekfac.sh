#!/bin/bash
# CIFAR-10, CNN 16-32-64 + GroupNorm, arm=ekfac. Writes to benchmarks/outputs/cnn_gn_cifar/ekfac/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/train_cnn_gn_cifar_ekfac.sh
...
#   sbatch --export=ALL,WCT_BUDGET=6543 benchmarks/slurm/train_cnn_gn_cifar_ekfac.sh
...
python -m benchmarks.cnn_gn_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cnn_gn_cifar/ekfac"
