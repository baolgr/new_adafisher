#!/bin/bash
# CIFAR-10, CNN 16-32-64 + GroupNorm, all 7 arms in one job. Writes to benchmarks/outputs/cnn_gn_cifar/.
...
# Submit from the repository root:  sbatch benchmarks/slurm/train_cnn_gn_cifar_all.sh
...
#
# The per-arm alternative is benchmarks/slurm/train_cnn_gn_cifar_<arm>.sh, one job each; use it if you
...
python -m benchmarks.cnn_gn_cifar.bench \
  ...
  --output-dir "$SLURM_SUBMIT_DIR/benchmarks/outputs/cnn_gn_cifar"
